...
Async client for sending structured logs to Axiom's ingest API.
Batches events and sends in background to avoid blocking requests.
"""
...
class AxiomClient:
    """Async Axiom client with batching and background shipping."""
...
def get_axiom_client() -> AxiomClient:
    ...
    if _axiom_client is None:
        _axiom_client = AxiomClient(
            ...
            site_name=os.getenv("SITE_NAME", "h3arted.com"),
        )
